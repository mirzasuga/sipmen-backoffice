...
// import SipmenWebsocket from '../resources/sipmenwebsocket'
...
if (typeof Pusher !== 'undefined') {
  ...
  window.Echo = new Echo({
    ...
    // host: 'ws://sipmen-echo-server.herokuapp.com:58852',
    // host: 'localhost:6001',
    cluster: 'ap1',
...
// window.SipmenWS = new SipmenWebsocket('ws://location-service.mdev:3001')
